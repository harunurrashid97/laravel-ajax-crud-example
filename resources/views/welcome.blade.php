...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="container">
        ...
        <p class="h2 mb-5">Welcome, Blog!</p>

        <div class="mt-5">
            <p class="h3">Whats your blog?</p>
            <button class="btn btn-primary" data-toggle="modal" data-target="#opinionWindow">Create Blog!</button>
                    ...
                    <div class="modal-content">
                        ...
                        <form id="opinionForm">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" id="submit" class="btn btn-primary">Save Blog</button>
                            </div>
                        </form>
                    </div>
                </div> 
